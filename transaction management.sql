...
create table account(act_no varchar(10), act_name varchar(10), act_balance bigint(10), act_dob date);
drop TABLE account;
-- not to use-- 


create table account_branch(act_no varchar(10), act_name varchar(10), act_branch varchar(10));
create table account_city(act_no varchar(10), act_name varchar(10), act_city varchar(10));
